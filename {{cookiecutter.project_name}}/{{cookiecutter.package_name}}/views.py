...
from {{ cookiecutter.package_name }}.permissions import IsAdminOrReadOnly
from {{ cookiecutter.package_name }}.models import Example
from {{ cookiecutter.package_name }}.serializers import ExampleSerializer
